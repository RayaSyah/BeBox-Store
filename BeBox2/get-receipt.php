...
<head>
    ...
    @media (max-width: 480px) {
        .receipt { padding: 20px 14px; border-radius: 14px; }
        .receipt-number { font-size: 16px; letter-spacing: 1px; }
        .receipt-page { padding: 16px 12px; gap: 14px; }
        .product-box { padding: 10px; gap: 10px; }
        .product-box img { width: 52px; height: 52px; }
        .action-group { gap: 8px; }
        .barcode { font-size: 12px; letter-spacing: 2px; }
    }
    @media print {
